...
<nav class="navbar navbar-expand-sm temno-siv text-light text-opacity-50 my-0 py-0 fs-6">
    ...
    <div class="row w-100">
        ...
        <div class="col-sm-4 py-5 mt-5 border border-dark-subtle rounded-3 siv">
            <h3 class="pb-3">Dodaj dodaten mobo</h3>
          <form action="" method="post">
            <div class="form-floating my-3">
                <input type="text" class="form-control" name="ime" placeholder="Ime">
                <label for="ime">Ime maticne plosce</label>
            </div>
            ...
            <div class="form my-3">
              <label for="socket" class="form-label">Izberi cip maticne plosce:</label>
                <select class="form-select"  name="socket" id="socket">
                  <option value="AM4">AM4</option>
                  <option value="AM5">AM5</option>
                  <option value="LGA1900">LGA1900</option>
                  <option value="LGA1200">LGA1200</option>
                </select>
            </div>
            <div class="form my-3">
              <label for="velikost" class="form-label">Izberi velikost maticne plosce:</label>
                <select class="form-select"  name="velikost" id="velikost">
            ...
            <div class="form-floating mb-3">
                ...
                <label for="chipset">Vrsta podnozja maticne plosce:</label>
            </div>
            <div class="form-floating mb-3">
                <input type="text" class="form-control" name="cena" placeholder="cena">
                <label for="cena">Cena maticne plosce v EUR</label>
            </div>
            <div class="form-floating mb-3">
            ...
            <div class="form mb-3">
              <label for="opis" class="form-label">Opis maticne plosce: </label>
...
$sql="insert into rso_mobo (ime, slika1, slika2, slika3, socket, velikost, chipset, cena, zaloga, opis) values ('$ime','$slika1','$slika2','$slika3','$socket','$velikost','$chipset','$cena','$zaloga','$opis')";
