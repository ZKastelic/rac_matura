    ...
    <div class="col-sm-6">
      <div class="row pb-5">
        <div class="col-sm-6">
                ...
                <?php
              $id=$_GET['id'];
              $sql = "SELECT * FROM rso_mobo WHERE id=$id limit 1";
              $rezultat=($db->query($sql));
              $user=$rezultat->fetch_assoc();
        ...
        <div class='col-sm-6'>
          ...
          <table>
            <tr>
              <td class='col-sm-3 fw-bold'>Socket maticne plosce</td>
              <td class='col-sm-9'>$user[socket]</td>
            </tr>
            <tr>
              <td class='col-sm-3 fw-bold'>Velikost maticne plosce</td>
              <td class='col-sm-9'>$user[velikost]</td>
            </tr>
            <tr>
              <td class='col-sm-3 fw-bold'>Podnozje maticne plosce</td>
