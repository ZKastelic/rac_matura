    ...
    <div class="col-sm-6">
      <div class="row pb-5">
        <div class="col-sm-6">
                ...
                <?php
              $id=$_GET['id'];
              $sql = "SELECT * FROM rso_ram WHERE id=$id limit 1";
              $rezultat=($db->query($sql));
              $user=$rezultat->fetch_assoc();
        ...
        <div class='col-sm-6'>
          ...
          <table>
            <tr>
              <td class='col-sm-3 fw-bold'>Kapaciteta RAM-a</td>
              <td class='col-sm-9'>$user[kapaciteta] GB</td>
            </tr>
            <tr>
              <td class='col-sm-3 fw-bold'>Hitrost RAM-a</td>
              <td class='col-sm-9'>$user[hitrost]</td>
            </tr>
            <tr>
              <td class='col-sm-3 fw-bold'>Generacija RAM-a</td>
