...
<nav class="navbar navbar-expand-sm temno-siv text-light text-opacity-50 my-0 py-0 fs-6">
        ...
        <div class="container-fluid">
          ...
          <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#collapsibleNavbar">
            ...
            <ul class="navbar-nav flex-row flex-wrap col-3">
              ...
              <li class="nav-item">
                <a class="nav-link text-dark" href="#">Racunalniki</a>
              </li>
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" href="#">Maticne plosce</a></li>
                </ul>
              </li>
            </ul>
            <div class="col-6">
              <form class="d-flex">
                <input class="form-control me-1" type="text" placeholder="Iskalnik">
    ...
    <div class="row w-100">
        ...
        <div class="col-sm-4 py-5 mt-5 border border-dark-subtle rounded-3 siv">
            <h3 class="pb-3">Dodaj dodaten RAM</h3>
          <form action="" method="post">
            ...
            <div class="form-floating mb-3">
                <input type="text" class="form-control" name="kapaciteta" placeholder="kapaciteta">
                <label for="tip">Kapaciteta RAM-a v GB</label>
            </div>
            <div class="form-floating mb-3">
                <input type="text" class="form-control" name="hitrost" placeholder="hitrost">
                <label for="hitrost">Hitrost RAM-a v MHz </label>
            </div>
            <div class="form my-3">
              <label for="generacija" class="form-label">Generacija RAM-a:</label>
                <select class="form-select"  name="generacija" id="generacija">
            ...
            <div class="form-floating mb-3">
                ...
                <label for="cena">Cena RAM-a v EUR</label>
            </div>
            <div class="form-floating mb-3">
            ...
            <div class="form mb-3">
              <label for="opis" class="form-label">Opis RAM-a: </label>
...
if(!empty($_POST)){
    ...
    $slika2=$_POST['slika2'];
    $slika3=$_POST['slika3'];
    $kapaciteta=$_POST['kapaciteta'];
    $hitrost=$_POST['hitrost'];
    $generacija=$_POST['generacija'];
    $cena=$_POST['cena'];
    $zaloga=$_POST['zaloga'];
    $opis=$_POST['opis'];

$sql="insert into rso_ram (ime, slika1, slika2, slika3, kapaciteta, hitrost, generacija, cena, zaloga, opis) values ('$ime','$slika1','$slika2','$slika3','$kapaciteta','$hitrost','$generacija','$cena','$zaloga','$opis')";
