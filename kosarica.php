...
<div class="row p-0 m-0">
    ...
    <div class="col-sm-3">
        <div class="col-6 my-5 border border-dark-subtle rounded-3 svetlo-siv h-100">
              <button class="btn btn-secondary btn-outline-dark text-dark" type="submit"> Pojdi na nasledni korak</button>
        </div>
    </div>
    <div class="col-sm-2"></div>
</div>
...
<footer class="container-fluid siv border-top border-dark text-center py-4 pb-0 mb-0 fixed-bottom">
  <div class="row siv">
