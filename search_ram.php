...
<div class="col-sm-6 border border dark p-5">
  <?php
    ...
    for($i=1; $i<$user+1; $i++){
      ...
      echo"<a href='prikaz_ram.php?id=$i' class='text-decoration-none text-body'>
...
<footer class="container-fluid siv border-top border-dark text-center pt-4 pb-0 mb-0 fixed-bottom">
  ...
  <div class="row moder">
    ...
    <div class="col-sm-4 text-center"><h6>Poslovalnica</h6>
      <ul class="text-center list-group-flush moder">
        <li class="list-group-item moder">Solski center Novo mesto</li>
        <li class="list-group-item moder">8000 Novo mesto</li>
        <li class="list-group-item moder">Slovenija</li>
      </ul>
    </div>
    <div class="col-sm-4">
