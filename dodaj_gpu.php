...
<nav class="navbar navbar-expand-sm temno-siv text-light text-opacity-50 my-0 py-0 fs-6">
    ...
    <div class="row w-100">
        ...
        <div class="col-sm-4 py-5 mt-5 border border-dark-subtle rounded-3 siv">
            <h3 class="pb-3">Dodaj dodaten GPU</h3>
          <form action="" method="post">
            ...
            <div class="form-floating mb-3">
                ...
                <label for="chipset">Ime podnozja</label>
            </div>
            <div class="form-floating mb-3">
                <input type="text" class="form-control" name="vram" placeholder="vram">
                <label for="vram">VRAM-a v GB </label>
            </div>
            <div class="form-floating mb-3">
                <input type="text" class="form-control" name="hitrost" placeholder="hitrost">
                <label for="hitrost">Hitrost v MHz </label>
            </div>
            
            <div class="form-floating mb-3">
                <input type="text" class="form-control" name="cena" placeholder="cena">
                <label for="cena">Cena GPU-ja v EUR </label>
            </div>
            <div class="form-floating mb-3">
            ...
            <div class="form mb-3">
              <label for="opis" class="form-label">Opis GPU-ja: </label>
...
$sql="insert into rso_gpu (ime, slika1, slika2, slika3, chipset, vram, hitrost, cena, zaloga, opis) values ('$ime', '$slika1', '$slika2', '$slika3', '$chipset', '$vram', '$hitrost', '$cena', '$zaloga', '$opis')";
